...
class RoutineTuesdayAddUpdateFragment : Fragment() {
    ...
    private fun bind(entry: Student) {
        binding.apply {
            ...
            sharedViewModel.setStartTime(entry.tuesdayStartTime)
    ...
    private fun addNewEntry() {
        ...
        if (isEntryValid()) {
            ...
            val action =
                RoutineTuesdayAddUpdateFragmentDirections
                    .actionRoutineTuesdayAddUpdateFragmentToRoutineViewPager2()
    ...
    companion object {
        private const val DAY_OF_WEEK = 3
